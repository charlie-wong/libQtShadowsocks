...
QRCodeCapturer::QRCodeCapturer(QWidget *parent) : QMainWindow(parent)
{
#ifdef Q_OS_WIN
...
void QRCodeCapturer::decodeCurrentRegion()
{
    ...
    if(!result.isNull()) {
        ...
        // it's very likely this signal would be emitted multiple
        // times the solution is to use Qt::DirectConnection signal-slot
        // connection and disconnect such a connection in the slot function
