...
ChaCha::ChaCha(const std::string &_key, const std::string &_iv) : m_position(0)
{
...
void ChaCha::chacha()
{
    ...
    uint32_t x04 = input[ 4], x05 = input[ 5], x06 = input[ 6], x07 = input[ 7];
    uint32_t x08 = input[ 8], x09 = input[ 9], x10 = input[10], x11 = input[11];
